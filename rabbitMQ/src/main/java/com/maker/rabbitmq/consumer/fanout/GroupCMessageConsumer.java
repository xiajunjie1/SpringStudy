 ...
 * C组的消费者
 * */
public class GroupCMessageConsumer {
    private static final String QUEUE_NAME="jay.c.group.queue";//队列名称，此队列并不是由生产者创建的
    ...
    private static void groupCConsumer() throws Exception{
        ...
        Consumer consumer=new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("【GroupCConsumer】接收数据："+msg);
