 ...
 * 需要配置routing key
 * */
public class GroupAMessageConsumer {
    private static final String ROUTING_KEY="jay.direct.key";//与生产者routing key匹配，可以接收到消息进行消费处理
    ...
    private static void groupAConsumer() throws Exception{
        ...
        Consumer consumer=new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("【GroupAConsumer】接收数据："+msg);
