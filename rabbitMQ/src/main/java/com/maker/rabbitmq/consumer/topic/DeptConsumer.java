...
public class DeptConsumer {
    private static final String ROUTING_KEY="#.dept.#";//匹配所有与dept相关的消息
    private static final String QUEUE_NAME="jay.dept.queue";//队列名称，此队列并不是由生产者创建的
    ...
    private static void deptConsumer() throws Exception{
        ...
        Consumer consumer=new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("【Dept】接收数据："+msg);
